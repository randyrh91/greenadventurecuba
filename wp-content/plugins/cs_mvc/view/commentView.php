...
<div class="container-fluid">
    <div class="row-fluid">
        <h1 style="text-align: center"><em class="fa fa-book"></em> <?= __(CS_L_VISITORBOOK) ?>
            (<?= count(get_comments()) ?>)</h1>
        <?php
                    ...
                    <div id="respond">
                        ...
                        <?php else : ?>
                            <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post"
                                ...
                                <textarea style="width: 100%" name="comment" id="comment" cols="100%" rows="10"
                                          tabindex="4"></textarea><br/>
                                <img src="<?= CS_MVC_URL_ASSETIC ?>/images/captcha.php" style="margin-bottom: 10px"><br/>
                                <label><?=__(CS_L_CAPTCHA)?></label>
                                <input name="code" type="text" style="width: 133px" /><br/>
                                <input name="submit" type="submit" class="btn success" id="commentSubmit" tabindex="5"
                                       value="Submit"/>
